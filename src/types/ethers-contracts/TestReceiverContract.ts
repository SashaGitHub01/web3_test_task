...
export interface TestReceiverContractInterface extends utils.Interface {
  functions: {
...
export interface TestReceiverContract extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestReceiverContractInterface;
